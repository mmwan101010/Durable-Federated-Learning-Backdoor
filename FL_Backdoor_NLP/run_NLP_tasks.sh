...
## 下面是自己做实验挑的具体PLr和Attack_num
python main_training.py --params utils/words_reddit_lstm.yaml --run_name Reddit_LSTM_Neurotoxin_GradMaskRatio1.0_PLr0.12_AttackNum100_Snorm3.0_nlastwords1_SentenceId0  --GPU_id 0  --gradmask_ratio 1.0 --is_poison True --poison_lr 0.12 --start_epoch 2000 --PGD 0   --semantic_target True --attack_num 100 --same_structure True --aggregate_all_layer 1 --defense True --s_norm 3.0 --sentence_id_list 0
python main_training.py --params utils/words_reddit_lstm.yaml --run_name Reddit_LSTM_Neurotoxin_GradMaskRatio0.75_PLr0.12_AttackNum100_Snorm3.0_nlastwords1_SentenceId0  --GPU_id 0  --gradmask_ratio 0.75 --is_poison True --poison_lr 0.12 --start_epoch 2000 --PGD 0   --semantic_target True --attack_num 100 --same_structure True --aggregate_all_layer 1 --defense True --s_norm 3.0 --sentence_id_list 0
python main_training.py --params utils/words_reddit_lstm.yaml --run_name Reddit_LSTM_Baseline_PLr0.02_AttackNum40_Snorm3.0_nlastwords1_SentenceId0  --GPU_id 0  --gradmask_ratio 1.0 --is_poison True --poison_lr 0.02 --start_epoch 2000 --PGD 0   --semantic_target True --attack_num 40 --same_structure True --aggregate_all_layer 1 --defense True --s_norm 3.0  --sentence_id_list 0
