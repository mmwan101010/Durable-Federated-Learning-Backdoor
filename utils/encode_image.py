...
parser.add_argument('--image_path', type=str, default='X:\Directory\code\ISSBA\data\imagenet\org\\0100031(1).jpg')
parser.add_argument('--out_dir', type=str, default='data/imagenet/bd/')
# secret 应该就是 target
# 因为不同的字符做出来的扰动是不同的，我们使用标签作为字符，加进去的就是同一个模板的扰动，因此这个模板出现时就会被判为这个标签？
parser.add_argument('--secret', type=str, default='weida')
